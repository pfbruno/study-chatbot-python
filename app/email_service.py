...
EMAIL_FROM = os.getenv("EMAIL_FROM", "StudyPro <onboarding@studypro.app>").strip()
APP_NAME = os.getenv("APP_NAME", "StudyPro").strip()
...
def send_verification_email(
    *,
    ...
    <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; color: #111827;">
      ...
      <p style="font-size: 16px; line-height: 1.7;">
        Sua conta foi criada com sucesso. Para liberar o acesso completo, confirme seu e-mail clicando no botão abaixo.
      </p>
      ...
      <p style="font-size: 14px; line-height: 1.7; color: #2563eb;">
        {verification_url}
      </p>
...
def send_welcome_email(
    *,
    ...
    <div style="font-family: Arial, sans-serif; max-width: 640px; margin: 0 auto; color: #111827;">
      ...
      <p style="font-size: 16px; line-height: 1.7;">
        Agora você já pode entrar na plataforma, começar seus treinos e acompanhar sua evolução.
      </p>
    </div>
    """
    return _send_email_via_resend(to_email, subject, html)