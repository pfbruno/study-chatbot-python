...
export default function Page() {
  return (
    <SeoPage
      ...
      sections={[
              {
                      "title": "Treino com questões",
                      "content": "O simulado é uma forma prática de testar conteúdos de diferentes áreas do conhecimento e desenvolver resistência para provas longas."
              },
              {
                      "title": "Correção orientada",
                      "content": "Depois de responder, o estudante consegue analisar erros, acertos e pontos que precisam de revisão."
              },
              {
                      "title": "Evolução por desempenho",
                      "content": "Com dados de tentativas e desempenho, fica mais fácil acompanhar a evolução e estudar com foco nas maiores dificuldades."
              }
      ]}
    />
  )
