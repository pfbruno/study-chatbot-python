...
export default function Page() {
  return (
    <SeoPage
      ...
      sections={[
              {
                      "title": "Erro não é só nota baixa",
                      "content": "Cada erro indica uma lacuna de interpretação, conteúdo ou estratégia. Entender o erro é essencial para evoluir."
              },
              {
                      "title": "Explicação direcionada",
                      "content": "A correção com IA pode ajudar a explicar por que uma alternativa está incorreta e qual conceito precisa ser revisado."
              },
              {
                      "title": "Estudo com mais clareza",
                      "content": "O objetivo do MinhAprovação é dar direção ao estudo: praticar, corrigir, revisar e acompanhar evolução."
              }
      ]}
    />
  )
