...
export default function Page() {
  return (
    <SeoPage
      ...
      sections=[{"{ title: 'Prática ativa', content: 'Ao responder questões, o estudante precisa recuperar informações, interpretar dados e aplicar conceitos, o que fortalece a aprendizagem.' },\n    { title: 'Identificação de erros', content: 'Os erros mostram onde a revisão deve ser concentrada. Isso evita estudar tudo novamente sem critério.' },\n    { title: 'Treino rápido', content: 'O modo treino permite praticar questões de forma objetiva, mantendo constância e criando rotina de estudo.' }"}]
    />
  )
}
