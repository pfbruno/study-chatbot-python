...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true);
    // Mock login - será integrado com backend
    setTimeout(() => {
      setLoading(false);
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 space-y-8">
          ...
          <p className="text-muted-foreground text-lg max-w-md">
            Continue de onde parou. Suas questões, simulados e progresso estão esperando por você.
          </p>
          <div className="flex gap-8">
            <div>
              <p className="font-heading text-2xl font-bold text-primary">50k+</p>
              <p className="text-sm text-muted-foreground">Alunos</p>
            </div>
            <div>
              <p className="font-heading text-2xl font-bold text-accent">87%</p>
              <p className="text-sm text-muted-foreground">Aprovação</p>
            </div>
            <div>
              <p className="font-heading text-2xl font-bold text-primary">100k+</p>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            <h2 className="font-heading text-2xl font-bold">Entrar na sua conta</h2>
